In this project, let's build a **Jobby App** with React JS by applying the concepts of Function Component, Class Component and State, React, React-Router-DOM, Authorization and Authentication, JWT Token, js-cookies, react-icons, react-loader-spinner .

### Refer to videos below:

<div style="text-align: center;">
  <video style="max-width:120%;box-shadow:0 2.8px 2.2px rgba(0, 0, 0, 0.12);outline:none;" loop="true"  controls="controls">
